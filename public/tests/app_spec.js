describe('LearnJS', function() {
  ...
  it('can append a profile link view to navbar', function() {
      ...
      it('reads the item from the database', function(done) {
        ...
        learnjs.popularAnswers(1).then(function(item) {
          ...
          expect(lambdaSpy.invoke).toHaveBeenCalledWith({
            ...
            Payload: JSON.stringify({body: JSON.stringify({ problemNumber: 1 })})
          });
          done();
        });
      });
  ...
  describe('googleSignIn callback', function() {
    ...
    it('fetches the AWS credentials and resolves the deferred', function(done) {
    ...
    describe('refresh', function() {
      ...
      it('does not re-prompt for consent when refreshing the token', function(done) {
        learnjs.identity.done(function(identity) {
          identity.refresh().then(function() {
  ...
  describe('problem view', function() {
    ...
    describe('skip button', function() {
      ...
      it('does not get added when at the last problem', function() {
        view.trigger('removingView');
